    ...
    <header className={cn(
      ...
      <div className="container-wide">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-1.5 p-1 rounded-[2rem] border border-white/60 bg-white/70 backdrop-blur-2xl shadow-[0_20px_50px_rgba(11,28,59,0.08)] z-10 mx-6">
            {navLinks.map((link) => {
