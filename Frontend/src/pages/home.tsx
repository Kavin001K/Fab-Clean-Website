...
const fallbackTestimonials: PublicReview[] = [
  { id: "1", customerName: "Ananya I.", location: "Pollachi", rating: 5, comment: "The quality is outstanding. My wedding silk sarees looked exactly like they did on the first day.", isTopRating: true, isBestRating: true, curationScore: 5, curationReason: null, aiProvider: null, aiModel: null, createdAt: new Date().toISOString(), orderNumber: null },
  { id: "2", customerName: "Vikram S.", location: "Kinathukadavu", rating: 5, comment: "Fab Clean's precision with leather jackets and shoes is unmatched. Highly professional from pickup to finishing.", isTopRating: true, isBestRating: true, curationScore: 5, curationReason: null, aiProvider: null, aiModel: null, createdAt: new Date().toISOString(), orderNumber: null },
  { id: "3", customerName: "Suresh P.", location: "Pollachi Town", rating: 5, comment: "Their 48-hour express delivery saved my business trip. Everything came back perfectly steamed and packed.", isTopRating: true, isBestRating: true, curationScore: 5, curationReason: null, aiProvider: null, aiModel: null, createdAt: new Date().toISOString(), orderNumber: null },
];
...
export default function Home() {
  ...
  return (
    <AppLayout>
      <SEO
        title="Fab Clean — Premium Dry Cleaning & Laundry in Pollachi"
        description="Pollachi's best dry cleaning and laundry service. Free doorstep pickup, eco-solvent cleaning for sarees, suits, shoes & daily wear. Call 93630 59595."
        ...
        schema={{
          ...
          "@graph": [
            {
              "@type": "LocalBusiness",
              "@id": "https://myfabclean.com/#business",
              "name": "Fab Clean",
              "alternateName": "Fab Clean Dry Cleaning & Laundry",
              "url": "https://myfabclean.com",
              "logo": "https://myfabclean.com/logo.webp",
              "image": "https://myfabclean.com/opengraph.jpg",
              "description": "Pollachi's premium dry cleaning and laundry service with eco-solvent care and free doorstep pickup.",
              ...
              "address": [
                {
                  "@type": "PostalAddress",
                  "streetAddress": "#16 Venkatramana Round Road, Opp Naturals / HDFC Bank",
              ...
              "sameAs": [
                "https://wa.me/919363059595"
              ],
              "hasMap": "https://maps.google.com/?q=Fab+Clean+Pollachi",
              "aggregateRating": {
            ...
            {
              "@type": "WebSite",
              "@id": "https://myfabclean.com/#website",
              "url": "https://myfabclean.com",
              "name": "Fab Clean",
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://myfabclean.com/services?q={search_term_string}",
            ...
            },
            {
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "How does Fab Clean's doorstep pickup work in Pollachi?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Schedule a free pickup online or via WhatsApp. We collect your clothes from your doorstep in Pollachi or Kinathukadavu, clean them using eco-solvent dry cleaning or premium laundry, and deliver them back within 48 hours."
                  }
                },
                {
                  "@type": "Question",
                  "name": "What is the minimum order for laundry service?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Our laundry service starts at ₹45 per kg with no minimum order. Dry cleaning starts at ₹150 per garment."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Does Fab Clean clean silk sarees and bridal lehengas?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes. Fab Clean specializes in delicate fabric care including silk sarees, cotton sarees, bridal lehengas, and embellished garments using eco-safe solvents that preserve embroidery and fabric integrity."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Where are Fab Clean's branches located?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Fab Clean has two branches: one in Mahalingapuram, Pollachi (#16 Venkatramana Round Road, Opp HDFC Bank) and one in Kinathukadavu (#442/11 Opp MLA Office, Krishnasamypuram)."
                  }
                },
                {
                  "@type": "Question",
                  "name": "How long does dry cleaning take at Fab Clean?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Standard turnaround is 48 hours. Express same-day service is available for select items. Contact us on WhatsApp at 93630 59595 for urgent requests."
                  }
                }
              ]
            }
            ...
            {testimonials.map((t, i) => (
              <FadeIn key={i} delay={0.1 * i}>
                <Card className="p-12 hover:shadow-[0_40px_100px_-20px_rgba(0,0,0,0.08)] transition-all h-full flex flex-col bg-background rounded-[4rem]">
                  ...
                  <p className="text-foreground text-2xl leading-[1.4] mb-12 font-serif italic pr-4">"{t.comment}"</p>
                  <div className="flex items-center gap-5 mt-auto">
                    ...
                    <div>
                      <div className="text-xl font-bold text-foreground leading-none mb-1.5">{t.customerName}</div>
