...
export default function Pricing() {
  ...
  return (
    <AppLayout>
      <SEO
        title="Pricing — Laundry & Dry Cleaning Rates in Pollachi | Fab Clean"
        description="Transparent pricing for dry cleaning, laundry & shoe spa in Pollachi. Sarees from ₹150, laundry from ₹45/kg. No hidden charges. Free pickup."
