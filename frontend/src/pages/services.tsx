...
export default function Services() {
  ...
  return (
    <AppLayout>
      <SEO
        title="Our Services — Dry Cleaning, Laundry & Shoe Spa | Fab Clean Pollachi"
        description="Premium dry cleaning for sarees, suits & lehengas. Laundry by KG. Artisan shoe spa. Eco-solvent care. Free pickup in Pollachi & Kinathukadavu."
        canonical="https://myfabclean.com/services"
        schema={{
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Dry Cleaning & Laundry Services",
          "provider": { "@id": "https://myfabclean.com/#business" },
          "areaServed": {
            "@type": "City",
            "name": "Pollachi",
          ...
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Fab Clean Services",
            "itemListElement": [
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Premium Dry Cleaning" }, "price": "150", "priceCurrency": "INR" },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Luxury Laundry" }, "price": "45", "priceCurrency": "INR" },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Shoe Spa & Restoration" }, "price": "300", "priceCurrency": "INR" },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "House Linen & Bedsheet Care" }, "price": "70", "priceCurrency": "INR" }
            ]
          }
        }}
      />
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 55% 45% at 90% 10%, hsla(87,54%,51%,0.10) 0%, transparent 60%)," +
              "radial-gradient(ellipse 45% 40% at 10% 90%, hsla(215,91%,54%,0.08) 0%, transparent 60%)",
          }}
        />
